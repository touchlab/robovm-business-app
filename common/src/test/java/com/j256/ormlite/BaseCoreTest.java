...
import org.robovm.samples.contactr.core.common.TestRoboVMContext;
import org.robovm.samples.contractr.core.common.SimpleConnectionSource;
...
public abstract class BaseCoreTest {
	...
	public void before() throws Exception {
		...
		TestRoboVMContext testRoboVMContext = new TestRoboVMContext(false, new File("."));
		Connection qwert = testRoboVMContext.createDb("qwert", false);
		connectionSource = new WrappedConnectionSource(new SimpleConnectionSource(qwert));
	...
	/*protected static class LimitAfterSelectDatabaseType extends SimpleConnectionSource {
