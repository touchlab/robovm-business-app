...
public class BigDecimalStringTypeTest extends BaseTypeTest  {
	...
	protected static class LocalBigDecimalNumeric {
		@DatabaseField(columnName = BIGDECIMAL_COLUMN, dataType = DataType.BIG_DECIMAL)
		BigDecimal bigDecimal;
	}

	protected static class BigDecimalNumericBadDefault {
		@DatabaseField(defaultValue = "not valid form", dataType = DataType.BIG_DECIMAL)
		BigDecimal bigDecimal;
	}
